    ...
    Rectangle {
        ...
        O.Calendar {
            ...
            onClicked: {
                ...
                //formatdateDay1=(date.getDate()<10 ? "0" +date.getDate():date.getDate())+"/"+((date.getMonth()+1)<10 ? "0" +(date.getMonth()+1):(date.getMonth()+1))+"/"+date.getFullYear()
                formatdateDay1=date.getFullYear()+","+((date.getMonth()+1)<10 ? "0" +(date.getMonth()+1):(date.getMonth()+1))+","+(date.getDate()<10 ? "0" +date.getDate():date.getDate())
                sendDate(formatdate)
                sendDayDate(formatdateDay1)
                popup.close()
            }
        }
