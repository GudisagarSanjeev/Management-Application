...
N.Dialog{
    ...
    property alias selectedDate: myCalendar.selectedDate
    ...
    Rectangle {
        ...
        O.Calendar {
            ...
            onClicked: {
                ...
                fformatdate = (date.getDate()<10 ? "0" +date.getDate():date.getDate())+"-"+(month_names[date.getMonth()])+"-"+date.getFullYear()

                console.log(fformatdate)


                sendtDate(fformatdate)
